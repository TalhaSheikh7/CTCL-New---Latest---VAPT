...
//function OrderBook() {
   ...
   // }
    ...
    function GetRequiredStockOrMargin(nCncMis, nToken, Exchange, nOrderAmt, nBuySell, nQty, nSegment, noid) {
        var nStockType;
        if (nQty == -1) {
            nQty = $("#txtqty").val();
        }
        ...
        if (nBuySell == 2) {
            if ((nSegment == 3 || nSegment == 8 || nSegment == 9) && nCncMis == 0) {
                document.getElementById('reqMarText1').innerHTML = 'REQUIRED STOCK';
                document.getElementById('availMarText1').innerHTML = 'AVAILABLE/STOCK';
                document.getElementById('excessMarText1').innerHTML = 'EXCESS STOCK';
            }
            else {
                document.getElementById('reqMarText1').innerHTML = 'REQUIRED MARGIN';
                document.getElementById('availMarText1').innerHTML = 'AVAILABLE/MARGIN';
                document.getElementById('excessMarText1').innerHTML = 'EXCESS MARGIN';
            }
        ...
        var nUserId = $("#txtSelectedClient").val().split('-')[0].trim(); //localStorage.getItem("UserId");
        var nOrderId = "";
